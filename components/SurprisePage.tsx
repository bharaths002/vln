...
//     100: `${BASE}images/1.jpg`,
//     101: `${BASE}images/2.jpg`,
//     102: `${BASE}images/3.jpg`,
//     103: `${BASE}images/4.jpg`,
//     104: `${BASE}images/5.jpg`,
//     105: `${BASE}images/6.jpg`,
//     106: `${BASE}images/7.jpg`,
//   };
...
const SurprisePage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Corner Decorations */}
      <div className="fixed top-8 left-8 text-8xl z-50 animate-float opacity-90 pointer-events-none">🌈</div>
      <div className="fixed top-8 right-8 text-8xl z-50 animate-float opacity-90 pointer-events-none delay-700">🎈</div>
      <div className="fixed bottom-8 left-8 text-8xl z-50 animate-float opacity-90 pointer-events-none delay-1000">🎈</div>
      <div className="fixed bottom-8 right-8 text-8xl z-50 animate-float opacity-90 pointer-events-none delay-300">🌈</div>
      ...
      <div className="z-20 w-full max-w-7xl flex flex-col items-center mt-12 mb-32">
            ...
            <div className="relative group">
              ...
              >
                <div className="text-center space-y-8">
                  ...
                  <div className="text-pink-500 text-xl leading-relaxed italic font-bold space-y-6">
                    <p>"My world became infinitely brighter ✨ The moment I met you.😽"</p>
                    <p>"I promise to love you with everything I have "💖MY LOVE 🫶."</p>
                  </div>
                  <div className="flex justify-center gap-6 pt-6 text-5xl">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-40">
                <div
                  onClick={toggleEnvelope}
                  className="bg-white p-6 rounded-full shadow-2xl transition-all duration-300 hover:scale-125 active:scale-95 cursor-pointer border-8 border-pink-100 animate-pulse"
                >
                  <span className="text-pink-600 text-4xl font-black">{isOpen ? "💝" : "❤️"}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full mt-40 bg-white/50 backdrop-blur-xl p-16 md:p-24 rounded-[5rem] shadow-[0_30px_60px_-15px_rgba(236,72,153,0.3)] border-8 border-white/80">
          <div className="text-center mb-20 space-y-6">
            ...
            <button
              onClick={scrollLeft}
              className="absolute left-6 top-1/2 -translate-y-1/2 text-pink-500 text-6xl hover:scale-125 transition-transform z-50"
            >
              ❮
            </button>
            ...
            <button
              onClick={scrollRight}
              className="absolute right-6 top-1/2 -translate-y-1/2 text-pink-500 text-6xl hover:scale-125 transition-transform z-50"
            >
              ❯
            </button>

            <p className="text-pink-500 font-black text-2xl uppercase tracking-[0.3em]">Magic Moments</p>
          </div>
